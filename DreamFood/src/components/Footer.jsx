...
import profilepic1 from '../assets/logo.jpg'

const Footer = () => {
  return (
    <div>
        <footer className="footer xl:px-24 py-10 px-4 text-base-content">
  <aside className="footer text-base-content">
    <img src={profilepic1} className='w-30 h-40'></img>
  ...
  <nav>
    ...
    <a className="link link-hover">+64 231 12802</a>
